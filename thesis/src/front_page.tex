% Logos
\newcommand{\ulb}{\includegraphics[scale=1.1]{pictures/logo_ULB2.pdf}}
\newcommand{\polytech}{\includegraphics[scale=0.35]{pictures/logo_polytech_FR.pdf}}
...
% Titre
\newcommand{\titleA}{\fontTitle{Interferometric stabilisation of a fibre-based}} % Titre identique au titre remis au secrétariat
\newcommand{\titleB}{\fontTitle{optical computer}} % (dans la langue de rédaction a priori)
% Sous-titre
\newcommand{\subtitle}{\fontSubtitle{Experimental study}}
% Titre du diplôme
...
\newcommand{\promCb}{\fontText{Lorenz Butschek}}
